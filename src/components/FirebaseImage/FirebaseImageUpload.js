        ...
        <div className="product-review-popup-container">
            ...
            >
                ...
                >
                    ...
                    <Form.Item name="shareReview" valuePropName="checked">
                        <Checkbox>Đồng ý chia sẻ nhận xét của bạn trên trang web?</Checkbox>
                    </Form.Item>

                    <Form.Item name="receiveNotifications" valuePropName="checked">
                        <Checkbox>Bạn muốn nhận thông báo về sản phẩm mới và ưu đãi đặc biệt từ chúng tôi không?</Checkbox>
                    </Form.Item>
            ...
            <List
                ...
                renderItem={(item) => (
                    <List.Item>
                        ...
                        />
                        <div>Người đánh giá: {item.name}</div>
